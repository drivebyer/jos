...
#define KSTKSIZE	(8*PGSIZE)   		// size of a kernel stack，8*4096
#define KSTKGAP		(8*PGSIZE)   		// size of a kernel stack guard，8*4096
...
#define UVPT		(ULIM - PTSIZE) /*0xef400000*/
// Read-only copies of the Page structures
#define UPAGES		(UVPT - PTSIZE) /*0xef000000*/
// Read-only copies of the global env structures
#define UENVS		(UPAGES - PTSIZE) /*0xeec00000*/
...
#define UTOP		UENVS /*0xeec00000*/
// Top of one-page user exception stack
#define UXSTACKTOP	UTOP /*0xeec00000*/
// Next page left invalid to guard against exception stack overflow; then:
// Top of normal user stack
#define USTACKTOP	(UTOP - 2*PGSIZE) /*0xeebfe000*/
...
#define USTABDATA	(PTSIZE / 2) /*0x00200000*/
